...
_G.packer_plugins = {
  ...
  rainbow = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/rainbow",
  ...
  ["vim-colortuner"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-colortuner",
  ...
  ["vim-gas"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-gas",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vim-vsnip",
    url = "https://github.com/hrsh7th/vim-vsnip"
  },
  vimux = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/vimux",
    url = "https://github.com/preservim/vimux"
  },
  ["wgsl.vim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/wgsl.vim",
